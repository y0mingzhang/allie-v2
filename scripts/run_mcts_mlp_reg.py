...
probe = (
    nn.Sequential(nn.Linear(1024, 128), nn.ReLU(), nn.Dropout(0.3), nn.Linear(128, 1))
    .float()
    .to("cuda:0")
)
probe.load_state_dict(torch.load("results/value_probe_mlp_128_reg_20k.pt", map_location="cuda:0"))
probe.eval()
