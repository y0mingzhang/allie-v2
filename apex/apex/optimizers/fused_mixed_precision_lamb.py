...
class FusedMixedPrecisionLamb(torch.optim.Optimizer):
    ...
    def load_state_dict(self, state_dict):
        ...
        id_map = {
            ...
            for old_id, p in zip(
                ...
                chain.from_iterable(g["params"] for g in groups), strict=False,
            )
        }
    ...
    def step(self, closure=None, grad_scaler=None):
        ...
        for gid, (group, group_full) in enumerate(
            zip(self.param_groups, self.param_groups_full_precision, strict=False)
        ):
            ...
            for p, p_full in zip(group["params"], group_full["params"], strict=False):
                if p.grad is None:
                    continue
