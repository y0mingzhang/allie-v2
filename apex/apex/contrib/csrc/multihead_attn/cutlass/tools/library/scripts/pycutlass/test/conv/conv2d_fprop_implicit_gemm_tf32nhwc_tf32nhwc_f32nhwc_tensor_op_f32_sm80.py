...
class Conv2dFpropImplicitGemmTF32nhwcTF32nhwcTF32nhwcTensorOpF32SM80(unittest.TestCase):
    def test_SM80_Device_Conv2d_Fprop_Analytic_ImplicitGemm_tf32nhwc_tf32nhwc_f32nhwc_tensor_op_f32(
        self,
    ):
        ...
        C = TensorDescription(element=cutlass.float32, layout=cutlass.TensorNHWC, alignment=8)
    ...
    def test_SM80_Device_Conv2d_Fprop_Optimized_ImplicitGemm_tf32nhwc_tf32nhwc_f32nhwc_tensor_op_f32_align2(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 8],
