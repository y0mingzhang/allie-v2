...
class GemmBF16TensorOpSm80(unittest.TestCase):
    def SM80_Device_Gemm_bf16n_bf16n_f32t_tensor_op_f32_64x128x64_32x64x64(self):
        ...
        A = TensorDescription(element=cutlass.bfloat16, layout=cutlass.ColumnMajor, alignment=8)
        B = TensorDescription(element=cutlass.bfloat16, layout=cutlass.ColumnMajor, alignment=8)
    ...
    def test_SM80_Device_Gemm_bf16t_bf16t_bf16t_tensor_op_f32_128x256x64_64x64x64(self):
        ...
        A = TensorDescription(element=cutlass.bfloat16, layout=cutlass.RowMajor, alignment=8)
        B = TensorDescription(element=cutlass.bfloat16, layout=cutlass.RowMajor, alignment=8)
        C = TensorDescription(element=cutlass.bfloat16, layout=cutlass.RowMajor, alignment=8)
