...
class Conv2dWgradImplicitGemmF16nhwcF16nhwcF32nhwcTensorOpF32SM80(unittest.TestCase):
    ...
    def test_SM80_Device_Conv2d_Wgrad_Optimized_ImplicitGemm_f16nhwc_f16nhwc_f32nhwc_tensor_op_f32(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 8],
    ...
    def test_Device_Conv2d_Wgrad_Analytic_ImplicitGemm_f16nhwc_f16nhwc_f32nhwc_tensor_op_f32_align4(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 8],
