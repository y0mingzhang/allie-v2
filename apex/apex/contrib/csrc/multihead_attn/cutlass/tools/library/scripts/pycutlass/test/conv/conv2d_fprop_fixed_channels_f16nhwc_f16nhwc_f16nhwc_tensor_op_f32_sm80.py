...
class Conv2dFpropFixedChannelsF16NHWCF16NHWCF16HNWCTensorOpF32SM80(unittest.TestCase):
    def test_SM80_Device_Conv2d_Fprop_Fixed_Channels_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f32_channels_8(
        self,
    ):
        ...
        operation = Conv2dOperation(
            ...
            iterator_algorithm=cutlass.conv.IteratorAlgorithm.fixed_channels,
            arch=80,
    ...
    def test_SM80_Device_Conv2d_Fprop_Fixed_Channels_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f32_channels_4(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 16],
