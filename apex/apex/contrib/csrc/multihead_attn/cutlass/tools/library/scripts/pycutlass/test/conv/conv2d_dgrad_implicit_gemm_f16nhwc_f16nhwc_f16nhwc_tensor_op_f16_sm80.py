...
class Conv2dDgradImplicitGemmF16nhwcF16nhwcF16nhwcTensorOpF16SM80(unittest.TestCase):
    def test_SM80_Device_Conv2d_Dgrad_Analytic_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16(
        self,
    ):
    ...
    def test_SM80_Device_Conv2d_Dgrad_Optimized_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 16],
    ...
    def test_SM80_Device_Conv2d_Dgrad_Analytic_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16_align4(
        ...
        C = TensorDescription(element=cutlass.float16, layout=cutlass.TensorNHWC, alignment=4)
    ...
    def test_SM80_Device_Conv2d_Dgrad_Optimized_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16_align4(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 16],
