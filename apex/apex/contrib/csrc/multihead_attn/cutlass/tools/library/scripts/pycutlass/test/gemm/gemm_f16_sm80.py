...
class GemmF16Sm80(unittest.TestCase):
    def test_SM80_Device_Gemm_f32t_f32n_f32t_tensor_op_bf16_f32_128x128x32_64x64x32(self):
        ...
        B = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=8)
    ...
    def test_SM80_Device_Gemm_f16n_f16n_f16t_tensor_op_f32_128x128x64_64x64x64(self):
        ...
        C = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=8)
    ...
    def test_SM80_Device_Gemm_f16n_f16t_f16t_tensor_op_f16_sliced_k_128x64x64_64x64x32(self):
        ...
        A = TensorDescription(element=cutlass.float16, layout=cutlass.ColumnMajor, alignment=8)
        B = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=8)
        C = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=4)
    ...
    def test_test_SM80_Device_Gemm_f16t_f16n_f16t_tensor_op_f16_sliced_k_128x64x64_64x64x32(self):
        ...
        A = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=8)
        B = TensorDescription(element=cutlass.float16, layout=cutlass.ColumnMajor, alignment=8)
        C = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=4)
    ...
    def test_SM80_Device_Gemm_f16t_f16t_f32n_tensor_op_f32_128x256x64_64x64x64(self):
        ...
        A = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=8)
        B = TensorDescription(element=cutlass.float16, layout=cutlass.RowMajor, alignment=8)
        C = TensorDescription(element=cutlass.float16, layout=cutlass.ColumnMajor, alignment=8)
