...
class Conv2dFpropImplicitGemmF16nhwcF16nhwcF16nhwcTensorOpF16SM80(unittest.TestCase):
    def test_SM80_Device_Conv2d_Fprop_Analytic_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16(
        self,
    ):
        ...
        C = TensorDescription(element=cutlass.float16, layout=cutlass.TensorNHWC, alignment=8)
        ...
        epilogue_functor = LinearCombination(
            C.element, C.alignment, math_inst.element_accumulator, cutlass.float16
        )

        operation = Conv2dOperation(
            conv_kind=cutlass.conv.Operator.fprop,
            iterator_algorithm=cutlass.conv.IteratorAlgorithm.analytic,
            arch=80,
    ...
    def test_SM80_Device_Conv2d_Fprop_Optimized_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 16],
    ...
    def test_SM80_Device_Conv2d_Fprop_Analytic_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16_align2(
        ...
        A = TensorDescription(element=math_inst.element_a, layout=cutlass.TensorNHWC, alignment=2)
        B = TensorDescription(element=math_inst.element_b, layout=cutlass.TensorNHWC, alignment=2)
        C = TensorDescription(element=cutlass.float16, layout=cutlass.TensorNHWC, alignment=8)
    ...
    def test_SM80_Device_Conv2d_Fprop_Optimized_ImplicitGemm_f16nhwc_f16nhwc_f16nhwc_tensor_op_f16_align2(
        self,
    ):
        math_inst = MathInstruction(
            instruction_shape=[16, 8, 16],
