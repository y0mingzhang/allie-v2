...
"""
    ...
    def emit(self, operation):
        ...
        values = {
            ...
            "align_a": str(
                1
            ),  # TRMM A's alignment is always 1 for no padding to work until we make zfill work with variable bytes
...
"""
    ...
    def emit(self, operation):
        ...
        self.instance_wrappers.append(
            SubstituteTemplate(
                self.instance_template[operation.trmm_kind],
                {
