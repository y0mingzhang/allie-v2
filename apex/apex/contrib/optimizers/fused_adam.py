...
class FusedAdam(torch.optim.Optimizer):
    ...
    def step(self, closure=None, grads=None, output_params=None, scale=1.0, grad_norms=None):
        ...
        for group, grads_this_group, output_params_this_group, grad_norm in zip(
            self.param_groups, grads_group, output_params_group, grad_norms, strict=False
        ):
            ...
            for p, grad, output_param in zip(
                group["params"], grads_this_group, output_params_this_group, strict=False
            ):
                ...
                if self._use_multi_tensor:
                    ...
                    for tl, t in zip(tensorlists, pl, strict=False):
                        tl.append(t)
