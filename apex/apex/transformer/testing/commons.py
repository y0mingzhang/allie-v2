...
def model_provider_func(
    ...
    *,
    ...
    return MyModel(
        hidden_size, pre_process, post_process, add_encoder=add_encoder, add_decoder=add_decoder
    )
...
class ToyParallelMLPFwdBwdStepFunc:
    ...
    def __call__(
        ...
        torch.Tensor, Callable[[torch.Tensor], tuple[torch.Tensor, dict[str, torch.Tensor]]]
    ]:
