...
from apex.transformer.utils import gather_split_1d_tensor, split_tensor_into_1d_equal_chunks
...
def _communicate(
    ...
    *,
    ...
    overlap_p2p_comm: bool = False,
    batch_p2p_comm: bool = True,
) -> tuple[torch.Tensor | FutureTensor | None, torch.Tensor | FutureTensor | None]:
...
def recv_forward(
    ...
    *,
    ...
    batch_p2p_comm: bool = True,
    timers: _Timers = None,
) -> torch.Tensor | FutureTensor | None:
...
def send_forward_backward_recv_forward_backward(
    ...
    *,
    ...
    batch_p2p_comm: bool = True,
    timers: _Timers = None,
) -> tuple[torch.Tensor | FutureTensor, torch.Tensor | FutureTensor]:
