...
parser.add_argument(
    "--prof", dest="prof", action="store_true", help="Only run 10 iterations for profiling."
)
...
print(f"keep_batchnorm_fp32 = {args.keep_batchnorm_fp32}", type(args.keep_batchnorm_fp32))
