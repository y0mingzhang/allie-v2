...
parser.add_argument(
    "--dataset", default="cifar10", help="cifar10 | lsun | mnist |imagenet | folder | lfw | fake"
)
...
parser.add_argument(
    "--classes", default="bedroom", help="comma separated list of classes for the lsun data set"
)
